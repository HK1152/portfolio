export const cvData = {
  personalInfo: {
    ...
    about: "Aspiring Full Stack Developer with practical experience in developing responsive and interactive web applications using modern frontend technologies and foundational backend concepts. Skilled in JavaScript logic building, database basics and structured application design. In addition to full stack development, I have built AI-driven automation workflows using n8n, including a complete content automation system that generates stories, creates AI videos, and publishes them automatically to YouTube. Eager to contribute to teams working on scalable web platforms and intelligent automation solutions."
  },
  education: [
    {
      id: 1,
      ...
      details: [
        "Focused on computer science fundamentals, programming, and development concepts",
    ...
    },
    {
      ...
      details: [
        "Practical training in web technologies (HTML5, CSS3, Bootstrap, cpp, JavaScript, ReactJs, NodeJs, ExpressJs)",
        "Exposure to database management and backend programming concepts",
        "PD lectures, soft skills development, and interview preparation included in the curriculum",
        "Hands-on project-based learning for responsive and scalable applications"
      ]
    }
  ],
  experience: [
